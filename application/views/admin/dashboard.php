    ...
    <div class="row">
      <div class="col-lg-9 main-chart">
        ...
        <div class="border-head">
          <h3>Dashboard Aplikasi Pemilihan Ketua Osim</h3>
        </div>
                ...
                <div class="col-md-12" style="padding-left: 25px">
                  <table>
                    <tr>
                      ...
                      <td>:</td>
                      <td width="10px"></td>
                      <td>PILKETOS (Pemilihan Ketua Osis)</td>
                    </tr>
                    <tr>
                      <th>Versi PHP</th>
                      <td>:</td>
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td width="10px"></td>
                      <td>Fajar Arifandi</td>
                    </tr>
                    <tr>
                      <th>Instansi</th>
                      <td>:</td>
                      <td width="10px"></td>
                      <td>MAN 2 Kota Pekanbaru</td>
                    </tr>
                    <tr>
      ...
      <div class="col-lg-3 ds">
        ...
        <h4 class="centered mt">
          ...
          <button 
            ...
            style="border:none; background:none; cursor:pointer; font-size:14px; margin-left:10px; color:#0d6efd;">
            [ Hide ]
          </button>
        </h4>

        <!-- First Activity -->
        <div class="aksi" id="activityBox">
          <!-- konten aktivitas kamu tetap di sini -->
          <p>Aktivitas 1: Login</p>
          <p>Aktivitas 2: Vote</p>
          <p>Aktivitas 3: Logout</p>
        </div>
      </div>
