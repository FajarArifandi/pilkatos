...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/importpemilih'); ?>" method="post" enctype="multipart/form-data" class="cmxform form-horizontal style-form">
            ...
            <div class="col-md-12" style="padding-left: 25px; padding-right: 25px">
              <div class="form">
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <a href="<?= base_url('assets/format import pemilih.csv'); ?>" class="btn btn-success">
              ...
              <div class="col-lg-9">
                ...
                <small class="text-muted">Hanya file CSV yang diizinkan. Silakan simpan file Excel sebagai CSV terlebih dahulu.</small>
              </div>
            </div>
